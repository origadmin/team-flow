...
# 记录进度
bd update <id> --notes "COMPLETED: module boundaries. IN PROGRESS: interface contracts"

# 设置文档路径
bd update <id> --set-metadata doc_path="{DOCS_INTERNAL}/architecture/"
```
...
- [ ] 接口契约已定义
- [ ] 依赖单向性验证通过
- [ ] beads issue 已更新 (bd update --notes "architecture complete")
```
