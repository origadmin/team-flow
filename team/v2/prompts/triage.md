...
> **Version**: v17.0
> **Updated**: 2026-05-09
> **Core principle**: Triage 创建 Task �?需求完整性检�?�?分类报告 �?用户确认 �?Task 工具调起�?Agent
>
> **新增**:
...
# 3. ⚠️ LAUNCH SUB-AGENT NOW (使用 Task 工具调起�?Agent，三层交接模�?
Task(
...
**⚠️ 分发规则**�?
- 用户确认后，**必须立即使用 Task 工具调起�?Agent**
- **禁止** Triage 自己执行分析/设计/编码
- Task 工具调用后，Triage 等待�?Agent 返回结果
